...
function startConversation() {
    fetch('https://chatbot-for-wonder-academy.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-wonder-academy.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbyz-g2HbZvf0cDa_vzBMkj9n9AHpa4et0ojmD_WNvhA21YZ1jDCj-nuf3cXzxQ2JxM8Kw/exec';
